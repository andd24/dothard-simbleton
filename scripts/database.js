...
const stateCodeNY = (businessObject) => {
...
export const getNyBusinesses = () => {
    const filteredItems = businesses.filter( stateCodeNY )
    return filteredItems
}

const industryManu = (businessObject) => {
...
export const getManuBusinesses = () => {
  const filteredIndustries = businesses.filter( industryManu )
  return filteredIndustries
}

export const getAgents = () => {
  const agentArray = businesses.map(businessObject => ({
    "name": businessObject.purchasingAgent.nameFirst + " " + businessObject.purchasingAgent.nameLast,
...
export const findCompany = (name) => {
  const matchingCompany = businesses.find(business => business.companyName === name)
